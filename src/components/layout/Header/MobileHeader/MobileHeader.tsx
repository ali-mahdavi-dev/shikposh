...
export const MobileHeader: React.FC<MobileHeaderProps> = ({
  ...
  return (
    <>
      <AntHeader
        className={`fixed! !top-0 !right-0 !left-0 !z-50 !border-b !border-gray-100/50 !bg-white/95 !px-3 !shadow-md backdrop-blur-md transition-all duration-300 ${
          scrolled ? '!shadow-xl' : ''
        }`}
        style={{
          height: 'auto',
      ...
      >
        <div className="mx-auto w-full max-w-7xl">
          <div className="flex h-16 items-center justify-between gap-1.5">
            {/* Logo - Right Side */}
            <motion.div
              className="flex w-auto flex-shrink-0 items-center gap-2"
            ...
            >
              <Link href="/" className="group flex items-center gap-2">
                <motion.div
                  className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-pink-500 via-purple-500 to-pink-600 shadow-lg shadow-pink-200/50 transition-all duration-300 group-hover:shadow-pink-300/70"
                ...
                <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
                  <Link href="/products">
                    <Button
                      ...
                      className="h-9 w-9 rounded-full text-gray-600 transition-all hover:bg-pink-50 hover:text-pink-600"
                      size="small"
                    />
                  </Link>
                </motion.div>
            ...
            <motion.div
              className="flex w-auto flex-shrink-0 items-center gap-1.5"
              initial={hasAnimated ? false : { opacity: 0, x: 20 }}
              animate={{ opacity: 1, x: 0 }}
            ...
            >
              ...
              <Tooltip title="منو" placement="bottom">
                <Button
                  ...
                  className="flex h-9 w-9 flex-shrink-0 rounded-full text-gray-600 hover:bg-pink-50"
                  size="small"
                />
              </Tooltip>
            </motion.div>
